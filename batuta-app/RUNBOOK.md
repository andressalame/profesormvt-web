...
- **phone_id placeholder `51904079121`** (los digitos de la linea; un phone_number_id real nunca colisiona). El DIA DEL CORTE, tras registrar el numero en Meta, reemplazarlo por el phone_number_id real re-mandando el payload completo de negocio-upsert (guardar el JSON; el upsert pisa todos los campos).
